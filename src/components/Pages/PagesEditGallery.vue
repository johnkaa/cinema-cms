<template>
  <div class="pages-edit__gallery-item">
...
export default {
  ...
  methods: {
    ...mapMutations(['updatePagesGalleryItem', 'deletePagesGalleryItem']),
    uploadFile() {
      const path = `pages/${this.id}/gallery/${this.gallery.id}`
